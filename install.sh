...
packages=(
    ...
    xdg-desktop-portal-hyprland hyprlock-git grim slurp swaync wl-clipboard cliphist nwg-look swww prismlauncher-qt5-git jre12-openjdk jre17-openjdk engrampa 
    ...
    brightnessctl pamixer papirus-icon-theme ttf-jetbrains-mono-nerd pipewire pipewire-jack python-webcolors python-scipy steam steam-native-runtime gamemode lib32-amdvlk lib32-gamemode
    pipewire-alsa pipewire-pulse thunar thunar-archive-plugin cava-git spicetify-cli atuin wlogout python-pywal gradience zsh-autosuggestions zsh-sudo zsh-syntax-highlighting adw-gtk3
)
